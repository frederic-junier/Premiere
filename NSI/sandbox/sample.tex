...
\usepackage[urlcolor=red,% Liens vers une page web
            ...
            colorlinks=true, unicode=true]{hyperref}

\hypersetup{
            pdftitle={Corrigé du TP de Révisions},
...
\title{Corrigé du TP de Révisions}
...
\item
  And another.
\item
  Un lien \href{https://frederic-junier.org/}{mon site}
\end{itemize}
