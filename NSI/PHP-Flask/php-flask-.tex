...
\end{lstlisting}
    ...
    \item
      ...
      \href{https://developer.mozilla.org/fr/docs/Glossaire/HTML}{HTML}
      de \passthrough{\lstinline!connexion.html!}. Si on édite ce
      fichier, on observe des balises particulières délimitées par des
      accolades pour insérer les paramètres et
      \passthrough{\lstinline!ident!} et
...
\end{lstlisting}
    ...
    \item
      ...
      observer que le moteur de template échappe par défaut les
      caractères spéciaux
      \href{https://developer.mozilla.org/fr/docs/Glossaire/HTML}{HTML}
    \end{itemize}
  \end{itemize}
