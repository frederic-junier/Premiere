...
1.  Ouvrir avec un navigateur Web la page
    ...
    paramètres tranmis dans
    l’[URL](https://developer.mozilla.org/fr/docs/Glossaire/URL) par
...
![Page web dynamique](images/Php_arch_shema.png "Page web dynamique")  
